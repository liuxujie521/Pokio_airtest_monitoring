...
def Facebook_login():
    try:
        ...
        poco("m_login_password").set_text('1881877')
        poco("u_0_4").click()
        sleep(5)
        #===========登陆账号密码固定===============
        skip_error.skip_pop_up()
...
if __name__ == '__main__' :
    ...
    #正式服
    Email_Account='test0136@qq.com'
    Mobile_Account='18818778156'
    Facebook_Account='18818778156'
    ...
    Namecheck_Email='Joyce'
    Namecheck_Mobile='Joyce'
    Namecheck_Facebook='Airtest'
